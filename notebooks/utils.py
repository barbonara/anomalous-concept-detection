...
class HookedModel():
    ...
    def get_last_token_activations(self, dataset, layers, max_tokens=None, batch_size=None):
        """
        ...
        layer_last_token_activations = {f'Layer_{j}': [] for j in range(len(layers))}  # Initialize storage for each layer
